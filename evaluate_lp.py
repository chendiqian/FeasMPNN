...
from data.utils import recover_lp_from_data
from models.feasible_unroll_model import FeasibleUnrollGNNLP
...
def main(args: DictConfig):
    ...
    ModelClass = TripartiteHeteroGNNLP if args.tripartite else BipartiteHeteroGNNLP
    ...
    model = FeasibleUnrollGNNLP(1, args.ipm_eval_steps, gnn,
    ...
    A, c, b, lb, ub = recover_lp_from_data(data.to('cpu'))
    for _ in range(20):
        _ = qr(A.T)
