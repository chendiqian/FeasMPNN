...
from models.plain_gnn_lp import PlainBipartiteHeteroGNNLP, PlainTripartiteHeteroGNNLP
...
def main(args: DictConfig):
    ...
    for run in range(args.runs):
        ModelClass = PlainTripartiteHeteroGNNLP if args.tripartite else PlainBipartiteHeteroGNNLP
